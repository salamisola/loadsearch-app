    ...
    return (
        <div className="container">
                ...
                <div className="thumbnails">
                    <div className="box">
                        ...
                        <div className="inner">
                            ...
                            <h3>Trucking and General News Feeds</h3>
                    ...
                    <div className="box">
                        ...
                        <div className="inner">
                            ...
                            <h3>Featured Adverts and Offers</h3>
                            <p>Lorem ipsum dolor sit amet, illum definitiones no quo, maluisset concludaturque et eum, altera fabulas ut quo. Atqui causae gloriatur ius te, id agam omnis evertitur eum. Affert laboramus repudiandae nec et. Inciderint efficiantur his ad. Eum no molestiae voluptatibus.</p>
                    ...
                    <div className="box">
                        ...
                        <div className="inner">
                            ...
                            <h3>Featured Stories and Articles</h3>
                            <p>Lorem ipsum dolor sit amet, illum definitiones no quo, maluisset concludaturque et eum, altera fabulas ut quo. Atqui causae gloriatur ius te, id agam omnis evertitur eum. Affert laboramus repudiandae nec et. Inciderint efficiantur his ad. Eum no molestiae voluptatibus </p>
            ...
            <div className="padding: 20px;">
                <box>
                    <ul>
                        <li><a href="The-Truck-Doctor">The Truck Doctor</a></li>
                        <li><a href="The-Truck-CPA">The Truck CPA</a></li>
                        <li><a href="All-About-Safety">All About Safety</a></li>
                        <li><a href="A-Day-in-the-Life-of-a-Trucker">A Day in the Life of a Trucker</a></li>
                        <li><a href="#l-1">Link 1</a></li>
                        <li><a href="#l-2">Link 2</a></li>
                        <li><a href="#l-3">Link 3</a></li>
                        <li><a href="#l-4">Link 4</a></li>
                    </ul>
                </box>
            </div>
